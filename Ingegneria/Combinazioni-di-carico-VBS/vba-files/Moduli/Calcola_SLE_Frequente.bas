Attribute VB_Name = "Calcola_SLE_Frequente"
'namespace=vba-files\Moduli

Sub calcola_combinazione_SLE_Frequente()

    Application.ScreenUpdating = False

    reset "Resetta SLE FREQUENTE"
    ...
    '-- CARICO Qk ----------------------------------------------------------------------------------------
        ...
        Else
            ...
            qkPrinc_Num = getQkPrincArray("NTC18", 1, "SLE FREQUENTE", "Qk", tot, rangeNum, rangeCorr, rangeQinput, rangeCondition, rangeAnalysis, rangeCategory, rangeState, "getQkPrincNum")
            qkPrinc_Category = getQkPrincArray("NTC18", 1, "SLE FREQUENTE", "Qk", tot, rangeNum, rangeCorr, rangeQinput, rangeCondition, rangeAnalysis, rangeCategory, rangeState, "getQkPrincCategory")
            qsl_qkPrinc_NTC08 = getQkPrincArray("NTC08", 1, "SLE FREQUENTE", "Qk", tot, rangeNum, rangeCorr, rangeQinput, rangeCondition, rangeAnalysis, rangeCategory, rangeState)
            qsl_qkPrinc_NTC18 = getQkPrincArray("NTC18", 1, "SLE FREQUENTE", "Qk", tot, rangeNum, rangeCorr, rangeQinput, rangeCondition, rangeAnalysis, rangeCategory, rangeState)
            
            qsl_qkSecon_NTC08 = getQkSeconArray("NTC08", 2, "SLE FREQUENTE", "Qk", tot, rangeCorr, rangeQinput, rangeCondition, rangeAnalysis, rangeCategory, rangeState)
            qsl_qkSecon_NTC18 = getQkSeconArray("NTC18", 2, "SLE FREQUENTE", "Qk", tot, rangeCorr, rangeQinput, rangeCondition, rangeAnalysis, rangeCategory, rangeState)
    ...
    '-- COMBINAZIONE SLE FREQUENTE -----------------------------------------------------------------------
        start_row = ws.Range(range_pointer("SLE FREQUENTE")).Row
        start_col = ws.Range(range_pointer("SLE FREQUENTE")).Column
