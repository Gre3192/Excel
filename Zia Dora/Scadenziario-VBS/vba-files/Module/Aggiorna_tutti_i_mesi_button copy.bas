Attribute VB_Name = "Aggiorna_tutti_i_mesi_button_copy"

Sub Aggiorna_tutti_i_mesi_copy()
    ...
    Dim Array_mesi() As Variant, Array_doAdded() As Variant, Array_doDeleted() As Variant
    ...
    Dim lastrow_uscite As Integer, lastrow_fornitori As Integer
    ...
    ReDim Array_ciane_input(0 To sh.Cells(lastrow_ciane_input, "A").Value - 1)
    For i = 0 To sh.Cells(lastrow_ciane_input, "A").Value - 1
        Array_ciane_input(i) = sh.Cells(16 + i, "B").Value
    Next
       
    Dim Array_fornitori_input() As Variant
    ReDim Array_fornitori_input(0 To sh.Cells(lastrow_fornitori_input, "H").Value - 1)
    For i = 0 To sh.Cells(lastrow_fornitori_input, "H").Value - 1
